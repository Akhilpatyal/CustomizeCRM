...
const DealsTable = ({
  ...
  // (parent fetches via `useAllMeetings({ limit, page, filters })`). Slicing it
  // again with currentPage/itemsPerPage was double-paginating — page 2 was
  // trying to slice indices [itemsPerPage..2*itemsPerPage] of a page-sized
  // array, giving [] back and rendering an empty table. Use `deals` as-is.
