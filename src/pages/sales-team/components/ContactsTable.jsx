...
const ContactsTable = ({
  ...
  const getConversionColor = (rate) => {
    ...
    return "bg-orange-200 text-orange-400 border-orange-300";
  };
        ...
        <table className="w-full">
          <thead className="bg-muted/50 border-b border-border">
            <tr>
              ...
              {[
                { key: "name", label: "Name" },
                { key: "leadAssign", label: "Leads Assigned" },
                { key: "siteVisite", label: "Site Visits" },
                { key: "dealClose", label: "Deals Closed" },
