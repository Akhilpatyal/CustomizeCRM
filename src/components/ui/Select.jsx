...
const Select = React.forwardRef(({
    ...
    // Close the dropdown when a pointer press lands outside the component.
    // `mousedown` fires before `click`, so the panel closes cleanly even when
    // the outside target has its own click handler.
    useEffect(() => {
        if (!isOpen) return;
